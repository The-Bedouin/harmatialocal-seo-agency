    ...
    <footer className="footer-glass">
        ...
        <div className="footer-row-wrap">
          <div className="footer-col footer-nav">
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.5rem' }}>
              <img src="/hlsalogo.png" alt="Harmatia Local SEO Agency Logo" style={{ height: '36px', marginRight: '10px' }} />
      ...
      <div className="footer-bottom-row">
        ...
        <div className="footer-copyright">
          <img src="/hlsalogo.png" alt="Harmatia Local SEO Agency Logo" style={{ height: '32px', verticalAlign: 'middle', marginRight: '8px' }} />
