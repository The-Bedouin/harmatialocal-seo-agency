    ...
    <footer className="footer-glass">
        ...
        <div className="footer-row-wrap">
          <div className="footer-col footer-nav">
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.5rem' }}>
              <Image src="/hlsalogo.png" alt="Harmatia Local SEO Agency Logo" width={200} height={60} style={{ height: '36px', width: 'auto', marginRight: '10px' }} />
      ...
      <div className="footer-bottom-row">
        ...
        <div className="footer-copyright">
          <Image src="/hlsalogo.png" alt="Harmatia Local SEO Agency Logo" width={180} height={54} style={{ height: '32px', width: 'auto', verticalAlign: 'middle', marginRight: '8px' }} />
